<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/home/www/admin/localhost_9002/wwwroot/public/../application/admin/view/work/statement/add.html";i:1607060280;s:81:"/home/www/admin/localhost_9002/wwwroot/application/admin/view/layout/default.html";i:1602168706;s:78:"/home/www/admin/localhost_9002/wwwroot/application/admin/view/common/meta.html";i:1602168706;s:80:"/home/www/admin/localhost_9002/wwwroot/application/admin/view/common/script.html";i:1602168706;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-statement_inoperator" class="form-control" name="row[statement_inoperator]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Statement_outoperator'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-statement_outoperator" class="form-control" name="row[statement_outoperator]" type="text">
        </div>
    </div>
    <div class="form-group">
