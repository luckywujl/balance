...
--
-- Table structure for table `bal_ems`
--

DROP TABLE IF EXISTS `bal_ems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_ems` (
...
--
-- Dumping data for table `bal_ems`
--

LOCK TABLES `bal_ems` WRITE;
/*!40000 ALTER TABLE `bal_ems` DISABLE KEYS */;
/*!40000 ALTER TABLE `bal_ems` ENABLE KEYS */;
UNLOCK TABLES;
