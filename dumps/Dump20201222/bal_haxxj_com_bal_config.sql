...
--
-- Table structure for table `bal_config`
--

DROP TABLE IF EXISTS `bal_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_config` (
