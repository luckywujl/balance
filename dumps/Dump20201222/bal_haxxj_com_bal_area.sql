...
--
-- Table structure for table `bal_area`
--

DROP TABLE IF EXISTS `bal_area`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_area` (
...
--
-- Dumping data for table `bal_area`
--

LOCK TABLES `bal_area` WRITE;
/*!40000 ALTER TABLE `bal_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `bal_area` ENABLE KEYS */;
UNLOCK TABLES;
