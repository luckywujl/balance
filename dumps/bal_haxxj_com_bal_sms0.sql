...
--
-- Table structure for table `bal_sms`
--

DROP TABLE IF EXISTS `bal_sms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_sms` (
...
--
-- Dumping data for table `bal_sms`
--

LOCK TABLES `bal_sms` WRITE;
/*!40000 ALTER TABLE `bal_sms` DISABLE KEYS */;
/*!40000 ALTER TABLE `bal_sms` ENABLE KEYS */;
UNLOCK TABLES;
