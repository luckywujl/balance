...
--
-- Table structure for table `bal_user_rule`
--

DROP TABLE IF EXISTS `bal_user_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_user_rule` (
