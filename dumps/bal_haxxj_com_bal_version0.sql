...
--
-- Table structure for table `bal_version`
--

DROP TABLE IF EXISTS `bal_version`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bal_version` (
...
--
-- Dumping data for table `bal_version`
--

LOCK TABLES `bal_version` WRITE;
/*!40000 ALTER TABLE `bal_version` DISABLE KEYS */;
/*!40000 ALTER TABLE `bal_version` ENABLE KEYS */;
UNLOCK TABLES;
